...
```{r}
p2 <- plotly::plot_ly(data = df_daily,
                x = ~ date,
                y = ~ active_cum, 
                name = 'Active', 
...
```
  ...
  Here is the trends:
```{r}
p3 <- plotly::plot_ly(data = df_trajectory) %>%
